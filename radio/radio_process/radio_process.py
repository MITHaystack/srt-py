...
class radio_process(gr.top_block):
    ...
    def __init__(self):
        ...
        self.nlog_k = nlog_k = -20*math.log10(fft_size) -10*math.log10(float(window_power) / fft_size)-20*math.log10(float(ref_scale) / 2)
        ...
        self.blocks_nlog10_ff_0 = blocks.nlog10_ff(10, fft_size, nlog_k)
        ...
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(num_integrations, 1.0/num_integrations, num_integrations, fft_size)
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.to_pmt(is_running), 100)
        self.blocks_keep_one_in_n_0 = blocks.keep_one_in_n(gr.sizeof_float*fft_size, num_integrations)
        ...
        self.connect((self.blocks_keep_one_in_n_0, 0), (self.zeromq_pub_sink_1_0, 0))
    ...
    def set_fft_size(self, fft_size):
        ...
        self.set_nlog_k(-20*math.log10(self.fft_size) -10*math.log10(float(self.window_power) / self.fft_size)-20*math.log10(float(self.ref_scale) / 2) )
    ...
    def set_num_integrations(self, num_integrations):
        ...
        self.blocks_keep_one_in_n_0.set_n(self.num_integrations)
        self.blocks_moving_average_xx_0.set_length_and_scale(self.num_integrations, 1.0/self.num_integrations)
        self.blocks_tags_strobe_0_0.set_value(pmt.to_pmt({"fft_size": self.fft_size, "samp_rate": self.samp_rate, "num_integrations": self.num_integrations, "motor_az": self.motor_az, "motor_el": self.motor_el, "freq": self.freq}))
